...
export default function HeroSection() {
  return (
    <section className="relative flex min-h-[60vh] items-center overflow-hidden bg-gradient-to-b from-[#fdfbf7] to-white text-[#071614] pt-24 pb-12">
      <div className="absolute inset-0 z-0">
        <img alt="دليل السبحي خلفية" className="h-full w-full object-cover object-center opacity-[0.08] mix-blend-multiply grayscale-[30%]" src={heroBg} fetchPriority="high" decoding="async" />
      ...
      <div className="relative z-10 mx-auto w-full max-w-6xl px-4 py-12 sm:px-6 lg:px-8 text-center">
        ...
        <div className="mx-auto flex flex-col items-center justify-center pt-6 pb-2">
          {/* 
            Container uses a subtle warm shadow and very light border.
            Image uses mix-blend-multiply to remove its solid white background, 
            allowing the container to show through as the logo's new background.
          */}
          <div className="relative flex h-56 w-56 sm:h-72 sm:w-72 md:h-[22rem] md:w-[22rem] lg:h-[26rem] lg:w-[26rem] items-center justify-center overflow-hidden rounded-full border border-[#d6b25e]/20 bg-white/70 shadow-[0_15px_40px_rgba(214,178,94,0.12)] backdrop-blur-sm transition-transform duration-700 hover:scale-105">
