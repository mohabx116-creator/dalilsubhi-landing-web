...
export default function ServicesSection() {
  ...
  return (
    <section className="bg-gray-50/50 py-20 backdrop-blur-[4px]">
      <div className="mx-auto max-w-7xl px-4 text-center sm:px-6 lg:px-8">
        <h2 className="text-3xl font-black text-[#071614] sm:text-4xl">محتوى الدليل</h2>
        <div className="mt-12 grid gap-8 text-right sm:grid-cols-3">
          {cards.map((card) => (
            <div key={card.title} className="flex flex-col overflow-hidden rounded-3xl border border-gray-100 bg-white/90 p-8 shadow-lg shadow-gray-200/40">
