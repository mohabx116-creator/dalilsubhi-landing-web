  ...
  return (
    <section id="community" className="bg-white/50 py-16 backdrop-blur-[4px]">
      <div className="mx-auto max-w-4xl px-4 text-center sm:px-6 lg:px-8">
        ...
        <div className="mx-auto mt-16 max-w-2xl rounded-3xl border border-[#0fa37f]/20 bg-white p-8 text-right shadow-[0_8px_30px_rgba(15,163,127,0.06)] transition hover:-translate-y-1 hover:shadow-[0_20px_40px_rgba(15,163,127,0.1)] sm:p-10">
