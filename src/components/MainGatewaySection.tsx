    ...
    <section className="relative z-10 overflow-hidden bg-gradient-to-b from-[#fdfbf7] via-[#faf8f2] to-[#f6f9f8] py-12 sm:py-24">
      ...
      <div className="relative z-10 mx-auto max-w-7xl px-4 text-center sm:px-6 lg:px-8">
        ...
        <div className="grid gap-6 text-right lg:grid-cols-3 sm:gap-8">
          <div className={`group flex h-full flex-col overflow-hidden rounded-[24px] sm:rounded-[30px] border bg-white/95 p-5 sm:p-8 md:p-10 shadow-lg backdrop-blur-md transition ${communityCard.colorClass} lg:col-span-3 lg:flex-row lg:items-center lg:gap-10`}>
          ...
          {cards.map((card) => (
            <div key={card.title} className={`group flex h-full flex-col overflow-hidden rounded-[24px] sm:rounded-[30px] border bg-white/95 p-5 sm:p-8 shadow-[0_8px_30px_rgba(0,0,0,0.04)] backdrop-blur-md transition ${card.colorClass} lg:col-span-1`}>
