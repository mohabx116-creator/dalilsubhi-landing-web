    ...
    <section id="facilities" className="bg-[#fdfbf7] px-4 py-12 sm:py-16 sm:px-6 lg:px-8">
      <div className="mx-auto max-w-7xl">
        <div className="mx-auto mb-8 sm:mb-10 max-w-3xl text-center">
          <p className="text-xs sm:text-sm font-bold text-[#b88622]">المرافق ونمط الحياة</p>
          <h2 className="mt-3 text-2xl font-black leading-snug text-[#071614] sm:text-4xl lg:text-5xl">
        ...
        <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
          {facilities.map(({ title, icon: Icon }) => (
            <article className="rounded-2xl sm:rounded-3xl border border-[#d6b25e]/18 bg-white/85 p-5 sm:p-6 shadow-sm" key={title}>
              ...
              <p className="mt-2 text-xs sm:text-sm leading-relaxed text-gray-600">محتوى واضح يساعدك في الوصول إلى خدمات المنطقة وروابطها الأساسية.</p>
            </article>
          ))}
        </div>
      </div>
